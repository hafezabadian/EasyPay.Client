...
constructor() { }
  ...
  // load css file in componnet html head
  ...
  loadChart() {
    ...
    var widgetlineChart = new Chartist.LineChart(
      '#Widget-line-chart',
      {
        labels: [1, 2, 3, 4, 5, 6],
    ...
    widgetlineChart.on('created', function (data:any) {
    ...
    widgetlineChart.on('draw', function (data:any) {
      var circleRadius = 10;
      if (data.type === 'point') {
    ...
    var lineArea = new Chartist.LineChart(
      '#line-chart',
      {
      ...
      },
      {
        ...
        axisY: {
          low: 0,
          scaleMinSpace: 60,
          labelInterpolationFnc: function labelInterpolationFnc(value:any) {
            return value / 1000 + 'K';
          }
        },
        axisX: {
    ...
    lineArea.on('created', function (data:any) {
      var defs = data.svg.elem('defs');
      defs
        .elem('linearGradient', {
          id: 'linear1',
    ...
    lineArea.on('draw', function (data:any) {
      var circleRadius = 10;
      if (data.type === 'point') {
        var circle = new Chartist.Svg('circle', {
          cx: data.x,
    ...
    var Stackbarchart = new Chartist.BarChart(
      '#Stack-bar-chart',
      {
    ...
    Stackbarchart.on('created', function (data:any) {
      var defs = data.svg.elem('defs');
      defs
        .elem('linearGradient', {
          id: 'StackbarGradient',
    ...
    Stackbarchart.on('draw', function (data:any) {
      if (data.type === 'bar') {
        data.element.attr({
    ...
    // Bar Chart Starts
    var barChart = new Chartist.BarChart(
      '#bar-chart',
      {
    ...
    barChart.on('created', function (data:any) {
      var defs = data.svg.elem('defs');
      defs
        .elem('linearGradient', {
          id: 'gradient4',
    ...
    barChart.on('draw', function (data:any) {
    ...
    var donut = new Chartist.PieChart(
    ...
    donut.on('created', function (data:any) {
      var defs = data.svg.elem('defs');
      defs
        .elem('linearGradient', {
          id: 'donutGradient1',
    ...
    donut.on('draw', function (data:any) {
      if (data.type === 'label') {
        if (data.index === 0) {
          data.element.attr({
